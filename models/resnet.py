...
def resnet18(pretrained=False, **kwargs):
    ...
    print('--------------------        load the pretrained model resnet18       --------------------------------------')
...
def resnet34(pretrained=False, **kwargs):
    ...
    print('--------------------        load the pretrained model   resnet34     --------------------------------------')
...
def resnet50(pretrained=False, **kwargs):
    ...
    print('--------------------        load the pretrained model  resnet50      --------------------------------------')
...
def resnet101(pretrained=False, **kwargs):
    ...
    print('--------------------        load the pretrained model  resnet101      --------------------------------------')
