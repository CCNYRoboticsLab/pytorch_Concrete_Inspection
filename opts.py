...
def parse_opts():
    ...
    parser.add_argument(
        '--result_path',
        default='resnet34',#  result_use_third_v2
        type=str,
    ...
    parser.add_argument(
        ...
        default='thirdego',
        type=str,
        help='Used dataset (activitynet | kinetics | ucf101 | hmdb51| thirdego)')
    parser.add_argument(
        '--n_classes',
        default=3,
        type=int,
    ...
    parser.add_argument(
        '--pretrain_path', default='', type=str, help='Pretrained model (.pth)') #results_Training_very_1/save_100.pth
    parser.add_argument(
        '--ft_begin_index',
        default=0,
        type=int,
